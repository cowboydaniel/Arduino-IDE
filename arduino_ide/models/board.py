...
DEFAULT_BOARDS = [
    Board(
        ...
        description="Classic Arduino board, perfect for beginners",
        price="$25",
        popularity=100,
        best_for=["Learning", "Simple projects", "Education"],
    ),
    Board(
        ...
        description="More memory and pins for complex projects",
        price="$45",
        popularity=85,
        best_for=["Complex projects", "Many sensors", "3D printing"],
    ),
    Board(
        ...
        description="Powerful WiFi & Bluetooth board for IoT",
        price="$10",
        popularity=95,
        best_for=["IoT", "WiFi projects", "Bluetooth", "Complex processing"],
    ),
    Board(
        ...
        description="Compact WiFi & BLE board with low power",
        price="$35",
        popularity=80,
        best_for=["Low power IoT", "Battery powered", "Wearables"],
    ),
]
